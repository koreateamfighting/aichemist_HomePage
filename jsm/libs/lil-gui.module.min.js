...
class a extends t {
    constructor(t, i, s, n) {
        ...
        super(t, i, s, 'color'),
            ...
            (this._format =
                ((l = this.initialValue), o.find((t) => t.match(l)))),
            (this._rgbScale = n),
        ...
        this.domElement.classList.add('root'),
            !p &&
                ...
                (!(function (t) {
                    ...
                    e
                        ? document.head.insertBefore(i, e)
        ...
        return (
            t.controllers &&
                this.controllers.forEach((i) => {
                    i instanceof h ||
                        (i._name in t.controllers &&
                            i.load(t.controllers[i._name]))
                }),
            i &&
                t.folders &&
